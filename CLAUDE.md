...
仅有连接骨架,迁移未实现(fail fast)。**状态:早期开发中。** 版本号以 Git tag 为唯一来源;发版 = 打 `vX.Y.Z` tag,由 GitHub Actions 自动发布(见 [docs/GITHUB.md](docs/GITHUB.md) 与 [ADR 0018](docs/DECISIONS/0018-git-tag-release.md))。
